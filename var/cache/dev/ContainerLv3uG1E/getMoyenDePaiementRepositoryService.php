 ...
 */
class getMoyenDePaiementRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MoyenDePaiementRepository' shared autowired service.
     *
     * @return \App\Repository\MoyenDePaiementRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MoyenDePaiementRepository.php';

        return $container->privates['App\\Repository\\MoyenDePaiementRepository'] = new \App\Repository\MoyenDePaiementRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
