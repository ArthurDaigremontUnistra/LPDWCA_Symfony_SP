...
class __TwigTemplate_2334ea6304b2729ca8aa7bee25f22e77 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1>Détails de la catégorie #";
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 16
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["category"]) || array_key_exists("category", $context) ? $context["category"] : (function () { throw new RuntimeError('Variable "category" does not exist.', 16, $this->source); })()), "description", [], "any", false, false, false, 16), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Type</th>
                <td>";
        // line 20
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["category"]) || array_key_exists("category", $context) ? $context["category"] : (function () { throw new RuntimeError('Variable "category" does not exist.', 20, $this->source); })()), "type", [], "any", false, false, false, 20), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
...
";
    ...
    {
        return array (  132 => 31,  127 => 29,  122 => 27,  112 => 20,  105 => 16,  98 => 12,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    <h1>Détails de la catégorie #{{ category.id }}</h1>
    ...
    <div class=\"btnContainer\">
        ...
        <div class=\"btn\"><div><a href=\"{{ path('app_category_edit', {'id': category.id}) }}\">Modifier</a></div></div>

    {{ include('category/_delete_form.html.twig') }}
{% endblock %}
", "category/show.html.twig", "C:\\symfony\\spbudget\\templates\\category\\show.html.twig");
    }
}
