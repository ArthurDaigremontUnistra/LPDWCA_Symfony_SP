...
/* user/new.html.twig */
class __TwigTemplate_165428fa566aeb3892bf7b70d5f4e26f extends Template
{
    private $source;
    private $macros = [];
...
{% block body %}
    <div class=\"form\">
        ...
        <div class=\"btn\"><div><a href=\"{{ path('app_user_index') }}\">Retour</a></div></div>
    </div>
{% endblock %}
", "user/new.html.twig", "C:\\symfony\\spbudget\\templates\\user\\new.html.twig");
    }
}
