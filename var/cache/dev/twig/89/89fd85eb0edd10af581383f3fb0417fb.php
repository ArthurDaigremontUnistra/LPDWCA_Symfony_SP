...
class __TwigTemplate_10c5754c99587b16e30e4ff8d9ae2339 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo "\" onsubmit=\"return confirm('Êtes-vous certain de vouloir supprimer l'utilisateur #";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 1, $this->source); })()), "id", [], "any", false, false, false, 1), "html", null, true);
        echo " ?');\">
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('app_user_delete', {'id': user.id}) }}\" onsubmit=\"return confirm('Êtes-vous certain de vouloir supprimer l'utilisateur #{{ user.id }} ?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ user.id) }}\">
    <div id=\"deleteBtn\"><button class=\"btn\">Supprimer</button></div>
</form>
", "user/_delete_form.html.twig", "C:\\symfony\\spbudget\\templates\\user\\_delete_form.html.twig");
    }
}
