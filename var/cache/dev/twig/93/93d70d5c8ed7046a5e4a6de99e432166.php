...
class __TwigTemplate_5c89875aab40d944469fd0901bbb87c4 extends Template
{
    private $source;
    private $macros = [];
...
{% block body %}
    <div class=\"form\">
        ...
        {{ include('category/_form.html.twig', {'button_label': 'Mettre à jour'}) }}

        <div class=\"btn\"><div><a href=\"{{ path('app_category_index') }}\">Retour</a></div></div>
    </div>
{% endblock %}
", "category/edit.html.twig", "C:\\symfony\\spbudget\\templates\\category\\edit.html.twig");
    }
}
